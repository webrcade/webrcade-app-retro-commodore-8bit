...
import keycodes from "./c64-keycodes.json";
...
const KEYS = {
  "default": [
    [
      ...
      new KeyDef("Run/Stop").setWidth(2).code("esc").setOnClick(onKey),
    ],
    [
    ...
    [
      new KeyDef("C=").code("")/*.setOnClick(onKey)*/,
    ...
    [
      new KeyDef("SHFT")/*.setOnClick(capsToggle)*/,
